...
```
Almost 60% of the accommodations have 4 or higher ratings. We can see that the average distance from the city center is about 0.1 kilometer higher in case of the highly rated places. The number of stars range between 1 and 5 stars in both rating groups, however the median number of stars is 4 in case of the highly rated, and 3 in case of the accommodations with lower ratings. We can also see that the number of rating reviews range in a wide scale including observations with very few ratings. For the subsequent analysis, I excluded accommodations with less than 50 reviews to avoid this noise. 
...
The LPM model has predictions out of the 0-1 range for 5.3% of the observations. The histograms suggest that in case of both models the distribution of the fitted probabilities among ccommodations with high ratings are are shifted towards the higher edge of the probability range. However, the distributions are overlapping which suggests that the predictive power of the two models are not that strong. 
